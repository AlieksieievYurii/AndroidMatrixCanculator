...
public class TagKeys {
    public static final String TAG_ID_MATRIX_A = "matrix_a";
    public static final String TAG_ID_MATRIX_B = "matrix_b";
    ...
    public static final String KEY_SHARED_MATRICES = "matrices";
